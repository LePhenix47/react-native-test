...
//Components
import { ScreenHeaderBtn, Welcome,Company,NearbyJobs, Specifics,PopularJobs,JobAbout,JobFooter,JobTabs,NearbyJobCard } from "../components"
  ...
  return (
    ...
    marginBottom:0
        ...
        options={{
            ...
            headerLeft: ()=>{
               return <ScreenHeaderBtn iconUrl={icons.menu} dimension="60%"></ScreenHeaderBtn> 
            },
            headerRight: ()=>{
               return <ScreenHeaderBtn iconUrl={images.profile} dimension="100%"></ScreenHeaderBtn> 
            },
            headerTitle: ""
        }}
        ></Stack.Screen>
